...
const ventana_flotante = (()=> {
    ...
    function nueva_ventana_flotante({
        ...
        let ocultar_elementos_por_maximizacion = () => {
            document.body.hijos_de_primer_nivel().filter(element => !element.querySelector(".maximizado")).forEach(elemento => {
